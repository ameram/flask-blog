...
# installed.
TK_PREFIX='/Users/ameer/Python/test-2/flaskr'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/ameer/Python/test-2/flaskr'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/ameer/Python/test-2/flaskr/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/ameer/Python/test-2/flaskr/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/ameer/Python/test-2/flaskr/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/ameer/Python/test-2/flaskr/lib/libtkstub8.6.a'
